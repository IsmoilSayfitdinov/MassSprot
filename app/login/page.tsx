        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Log in to your account to continue your training journey
            </p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/20 via-background to-accent/20 items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Train smarter with AI-powered analytics
          </h2>
          <p className="text-muted-foreground">
            Get personalized training recommendations, track your progress, 
